            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <ul className="flex space-x-4">
                  ...
                  <li>
                    <Link href={'/explore'}>
                      <span className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Explore</span>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/post'}>
                      <span className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Post</span>
                    </Link>
                  </li>
                  <li>
                    <Link href={'/saved'}>
                      <span className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Liked&Saved</span>
                    </Link>
                  </li>
                </ul>
              </div>
